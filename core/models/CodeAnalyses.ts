...
export function CodeAnalysesToJSON(json: any): CodeAnalyses {
    return CodeAnalysesToJSONTyped(json, false);
}

export function CodeAnalysesToJSONTyped(value?: CodeAnalyses | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
