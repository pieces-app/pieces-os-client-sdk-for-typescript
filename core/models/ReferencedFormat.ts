...
export function ReferencedFormatToJSON(json: any): ReferencedFormat {
    return ReferencedFormatToJSONTyped(json, false);
}

export function ReferencedFormatToJSONTyped(value?: ReferencedFormat | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
