...
export function WorkstreamPatternEngineVisionEventsToJSON(json: any): WorkstreamPatternEngineVisionEvents {
    return WorkstreamPatternEngineVisionEventsToJSONTyped(json, false);
}

export function WorkstreamPatternEngineVisionEventsToJSONTyped(value?: WorkstreamPatternEngineVisionEvents | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
