...
import {
    ...
    ReferencedWorkstreamEventToJSONTyped,
...
export function FlattenedWorkstreamEventsToJSON(json: any): FlattenedWorkstreamEvents {
    return FlattenedWorkstreamEventsToJSONTyped(json, false);
}

export function FlattenedWorkstreamEventsToJSONTyped(value?: FlattenedWorkstreamEvents | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
