...
export function OSHealthToJSON(json: any): OSHealth {
    return OSHealthToJSONTyped(json, false);
}

export function OSHealthToJSONTyped(value?: OSHealth | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
