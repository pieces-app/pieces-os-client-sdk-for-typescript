...
import {
    ...
    TLPDirectedDiscoveryFilterEnumToJSONTyped,
 ...
 */
export function instanceOfTLPDirectedDiscoveryFilter(value: object): value is TLPDirectedDiscoveryFilter {
...
export function TLPDirectedDiscoveryFilterToJSON(json: any): TLPDirectedDiscoveryFilter {
    return TLPDirectedDiscoveryFilterToJSONTyped(json, false);
}

export function TLPDirectedDiscoveryFilterToJSONTyped(value?: TLPDirectedDiscoveryFilter | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
