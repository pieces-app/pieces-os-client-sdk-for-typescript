...
export function QGPTRepromptOutputToJSON(json: any): QGPTRepromptOutput {
    return QGPTRepromptOutputToJSONTyped(json, false);
}

export function QGPTRepromptOutputToJSONTyped(value?: QGPTRepromptOutput | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
