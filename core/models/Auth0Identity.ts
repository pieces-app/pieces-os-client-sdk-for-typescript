 ...
 */
export function instanceOfAuth0Identity(value: object): value is Auth0Identity {
    return true;
}
...
export function Auth0IdentityToJSON(json: any): Auth0Identity {
    return Auth0IdentityToJSONTyped(json, false);
}

export function Auth0IdentityToJSONTyped(value?: Auth0Identity | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
