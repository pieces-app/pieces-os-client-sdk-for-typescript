 ...
 */
export function instanceOfSeededUltraSuiteAsset(value: object): value is SeededUltraSuiteAsset {
...
export function SeededUltraSuiteAssetToJSON(json: any): SeededUltraSuiteAsset {
    return SeededUltraSuiteAssetToJSONTyped(json, false);
}

export function SeededUltraSuiteAssetToJSONTyped(value?: SeededUltraSuiteAsset | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
