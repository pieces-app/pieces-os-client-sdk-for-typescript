 ...
 */
export function instanceOfExternalProviders(value: object): value is ExternalProviders {
...
export function ExternalProvidersToJSON(json: any): ExternalProviders {
    return ExternalProvidersToJSONTyped(json, false);
}

export function ExternalProvidersToJSONTyped(value?: ExternalProviders | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
