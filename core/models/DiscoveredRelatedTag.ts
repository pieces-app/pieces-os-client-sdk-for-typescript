...
export function DiscoveredRelatedTagToJSON(json: any): DiscoveredRelatedTag {
    return DiscoveredRelatedTagToJSONTyped(json, false);
}

export function DiscoveredRelatedTagToJSONTyped(value?: DiscoveredRelatedTag | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
