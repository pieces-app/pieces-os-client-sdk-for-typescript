...
import {
    ...
    SearchedWorkstreamSummaryToJSONTyped,
 ...
 */
export function instanceOfSearchedWorkstreamSummaries(value: object): value is SearchedWorkstreamSummaries {
...
export function SearchedWorkstreamSummariesToJSON(json: any): SearchedWorkstreamSummaries {
    return SearchedWorkstreamSummariesToJSONTyped(json, false);
}

export function SearchedWorkstreamSummariesToJSONTyped(value?: SearchedWorkstreamSummaries | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
