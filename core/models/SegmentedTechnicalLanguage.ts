...
import {
    ...
    SegmentedTechnicalLanguageFragmentToJSONTyped,
 ...
 */
export function instanceOfSegmentedTechnicalLanguage(value: object): value is SegmentedTechnicalLanguage {
...
export function SegmentedTechnicalLanguageToJSON(json: any): SegmentedTechnicalLanguage {
    return SegmentedTechnicalLanguageToJSONTyped(json, false);
}

export function SegmentedTechnicalLanguageToJSONTyped(value?: SegmentedTechnicalLanguage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
