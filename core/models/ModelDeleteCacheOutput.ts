...
export function ModelDeleteCacheOutputToJSON(json: any): ModelDeleteCacheOutput {
    return ModelDeleteCacheOutputToJSONTyped(json, false);
}

export function ModelDeleteCacheOutputToJSONTyped(value?: ModelDeleteCacheOutput | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
