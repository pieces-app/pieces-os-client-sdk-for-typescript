...
export function Auth0UserMetadataToJSON(json: any): Auth0UserMetadata {
    return Auth0UserMetadataToJSONTyped(json, false);
}

export function Auth0UserMetadataToJSONTyped(value?: Auth0UserMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
