...
export function SeededDiscoverableAssetToJSON(json: any): SeededDiscoverableAsset {
    return SeededDiscoverableAssetToJSONTyped(json, false);
}

export function SeededDiscoverableAssetToJSONTyped(value?: SeededDiscoverableAsset | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
