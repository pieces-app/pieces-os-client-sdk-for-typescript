...
export function FlattenedAnchorsToJSON(json: any): FlattenedAnchors {
    return FlattenedAnchorsToJSONTyped(json, false);
}

export function FlattenedAnchorsToJSONTyped(value?: FlattenedAnchors | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
