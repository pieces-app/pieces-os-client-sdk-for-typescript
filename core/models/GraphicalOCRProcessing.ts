...
import {
    ...
    GraphicalOCRStatisticsToJSONTyped,
...
export function GraphicalOCRProcessingToJSON(json: any): GraphicalOCRProcessing {
    return GraphicalOCRProcessingToJSONTyped(json, false);
}

export function GraphicalOCRProcessingToJSONTyped(value?: GraphicalOCRProcessing | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
