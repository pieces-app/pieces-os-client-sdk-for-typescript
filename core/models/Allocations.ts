...
export function AllocationsToJSON(json: any): Allocations {
    return AllocationsToJSONTyped(json, false);
}

export function AllocationsToJSONTyped(value?: Allocations | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
