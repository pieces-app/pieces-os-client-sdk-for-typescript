...
exports.DetectedExternalApplicationsFromJSON = DetectedExternalApplicationsFromJSON;
...
function DetectedExternalApplicationsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.DetectedExternalApplicationsToJSON = DetectedExternalApplicationsToJSON;
