...
function SeededAssetFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'enrichment': !(0, runtime_1.exists)(json, 'enrichment') ? undefined : (0, index_1.SeededAssetEnrichmentFromJSON)(json['enrichment']),
    };
}
...
function SeededAssetToJSON(value) {
    ...
    return {
        ...
        'pseudo': value.pseudo,
        'enrichment': (0, index_1.SeededAssetEnrichmentToJSON)(value.enrichment),
    };
}
