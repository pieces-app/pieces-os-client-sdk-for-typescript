...
function SegmentedTechnicalLanguageFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'iterable': (json['iterable'].map(index_1.SegmentedTechnicalLanguageFragmentFromJSON)),
    };
}
...
function SegmentedTechnicalLanguageToJSON(value) {
    ...
    return {
        ...
        'iterable': (value.iterable.map(index_1.SegmentedTechnicalLanguageFragmentToJSON)),
    };
}
