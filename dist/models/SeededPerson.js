...
function SeededPersonFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'access': !(0, runtime_1.exists)(json, 'access') ? undefined : (0, index_1.PersonAccessFromJSON)(json['access']),
        'type': (0, index_1.PersonTypeFromJSON)(json['type']),
        'model': !(0, runtime_1.exists)(json, 'model') ? undefined : (0, index_1.PersonModelFromJSON)(json['model']),
